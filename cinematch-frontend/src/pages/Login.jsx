            ...
            <form className="form_container" onSubmit={handleSubmit}>
                ...
                <div className="title_container">
                    ...
                    <span className="subtitle">
                        Get started with our app, sign in and enjoy the experience.
                    </span>
                </div>
                ...
                <div className="input_container">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" className="icon" viewBox="0 0 24 24">
                ...
                <div className="input_container">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" className="icon" viewBox="0 0 24 24">
                        <path stroke="#141B34" strokeLinecap="round" strokeWidth="1.5" d="M18 11.004A3.65 3.65 0 0 0 14.952 9.1 103 103 0 0 0 10.329 9c-1.65 0-3.148.034-4.623.1-1.753.077-3.193 1.388-3.427 3.062C2.126 13.254 2 14.373 2 15.513s.126 2.26.279 3.352c.234 1.674 1.674 2.985 3.427 3.063.714.031 1.554.055 2.294.072"></path>
                        <path stroke="#141B34" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6 9V6.5a4.5 4.5 0 0 1 9 0V9"></path>
                        <path fill="#141B34" d="m21.205 15.105-.58.59zm.215 1.372a.829.829 0 0 0 1.16-1.183zm-3.397-1.373-.58-.59zm.215 2.935a.828.828 0 1 0 1.16-1.183zm-3.978 2.723a1.45 1.45 0 0 1-2.02 0l-1.161 1.182a3.11 3.11 0 0 0 4.342 0zm-2.02 0a1.35 1.35 0 0 1 0-1.942l-1.161-1.182a3.01 3.01 0 0 0 0 4.306zm0-1.942a1.45 1.45 0 0 1 2.02 0l1.161-1.182a3.11 3.11 0 0 0-4.342 0zm2.02 0a1.353 1.353 0 0 1 0 1.942l1.161 1.182a3.01 3.01 0 0 0 0-4.306zm6.364-3.124.796.78 1.16-1.181-.795-.782zm-5.203 3.124 2.387-2.343-1.161-1.183-2.387 2.344zm2.387-2.343.795-.781-1.16-1.183-.796.781zm-1.161 0 1.59 1.562 1.162-1.183-1.591-1.562zm5.138-1.964c-.358-.351-.685-.675-.986-.9-.32-.24-.703-.441-1.185-.441v1.656s.005 0 .026.008c.026.01.078.037.166.103.19.143.427.372.818.757zm-3.182 1.183c.392-.385.627-.614.819-.757a.8.8 0 0 1 .166-.103c.02-.009.025-.008.026-.008v-1.656c-.483 0-.866.201-1.186.441-.3.225-.627.549-.986.9z"></path>
                    </svg>
